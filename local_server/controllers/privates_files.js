...
//prv upload
  exports.upload_one_private_file = (req, res) => {   //?save a file(path, size_count) of a user in database
    func.check_and_return(res, req.body.user_id, 400, 'Missing userID in request');
...
//del a file
  exports.delete_a_private_file = (req, res) => {   //?delete a file of one user(database, folder 'data')
    func.check_and_return(res, req.body.user_id, 400, 'Missing userID in request');
...
//prv download
  exports.return_file_to_download = (req, res) => {   //?download a file on the computer of the user
